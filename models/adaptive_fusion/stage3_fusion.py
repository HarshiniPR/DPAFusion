...
class AdaptiveSpatialFusionStage3(nn.Module):
    ...
    Consumes:
        ...
        - Stage 2 Decision Vector (actions): c_rgb, c_th, c_comp, z_w, alpha_op, g_int
    Outputs:
    ...
    def execute_primitive_operators(self, Fr, Ft, W_rgb, W_th):
        """ Evaluates the K=4 primitive fusion operators """
    ...
    def forward(self, Fr, Ft, Fu, Sc, actions):
        ...
        # Step A: Generate Dense Spatial Region Weights
        ...
        # Step B: Multi-Operator Primitive Mixture
